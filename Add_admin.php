...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	if(isset($_SESSION['admin']))
		echo '<li id="a1"><a id="onlink" href="Add_admin.php">Add admin</a></li><li id="a1"><a href="Add_to_home.php">All users</a></li>';
	if(isset($_SESSION['email'])){
...
if($rowCount > 0){
	...
	?>
	<form action="res_add_admin.php" method="POST">
		<span class="a">Name:</span>
		<input type="text" name="name" required>
		<br><br>
		<span class="a">Birth date:</span>
		<input type="date" name="bdate" required>
		<br><br>
		<span class="a">Mobile number:</span>
