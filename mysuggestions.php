...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    if(isset($_SESSION['admin'])&& $_SESSION['admin']==1){
      echo '<li id="a1"><a id="onlink" href="mysuggestions.php">Suggestions</a></li>';
    }
  ...
  if($db){
    ...
    if($res->num_rows > 0){
      while($row = $res->fetch_assoc()){
        ...
        echo "<span class=\"d1\"><a>".$row["subject"]."</a></span><br><br>";
        echo "<span class=\"d3\"><a>Written by ".$row["sender"]."</a></span><br><br>";
        //echo "<span class=\"d2\">By".str_repeat("&nbsp;", 1) .$row["email"]."</span><br><br>";
        $tmp=date("d/m/Y", strtotime($row["date"]));
        echo $tmp."<br>";
        //echo "<div class=\"item\">";
        echo "<span class=\"d3\">"."<div class=\"item\">".$row["content"]."</div>"."</span><br><br><br><br><br>";
        echo "</div>";
      }  
    }
    else{
